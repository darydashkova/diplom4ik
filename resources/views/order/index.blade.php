                    ...
                    <div class="table-block flex-table-page5">
                        ...
                        <div class="table-block__page5 table-block__page5-scroll">
                            ...
                            <div class="page5-table-flex-select">
                                ...
                                <div class="table-block__page5-item table-block_border-right">
                                    <select class="select-zakaz" data-entity="status" data-id="{{ $value->id  }}">
                                        <option value="Отправлен" @if($value->status=='Отправлен') selected @endif>Отправлен</option>
                                        <option value="Изготавливается" @if($value->status=='Изготавливается') selected @endif>Изготавливается</option>
                                    </select>
                                </div>
                                <!-- <div class="table-block__page5-item">
                                    {{ $value->status  }}
